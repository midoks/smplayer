...
- (NSArray *)mas_makeConstraints:(void(^)(MASConstraintMaker *make))blocks {
    ...
    for (MAS_VIEW *view in self) {
        ...
        [constraints addObjectsFromArray:[view mas_makeConstraints:blocks]];
    }
    return constraints;
}
...
- (NSArray *)mas_updateConstraints:(void(^)(MASConstraintMaker *make))blocks {
    ...
    for (MAS_VIEW *view in self) {
        NSAssert([view isKindOfClass:[MAS_VIEW class]], @"All objects in the array must be views");
        [constraints addObjectsFromArray:[view mas_updateConstraints:blocks]];
    }
    return constraints;
}
...
- (NSArray *)mas_remakeConstraints:(void(^)(MASConstraintMaker *make))blocks {
    ...
    for (MAS_VIEW *view in self) {
        NSAssert([view isKindOfClass:[MAS_VIEW class]], @"All objects in the array must be views");
        [constraints addObjectsFromArray:[view mas_remakeConstraints:blocks]];
    }
    return constraints;
}
