...
- (NSArray *)mas_makeConstraints:(__attribute__((noescape)) void(^)(MASConstraintMaker *))block {
...
- (NSArray *)mas_updateConstraints:(__attribute__((noescape)) void(^)(MASConstraintMaker *))block {
    self.translatesAutoresizingMaskIntoConstraints = NO;
    MASConstraintMaker *constraintMaker = [[MASConstraintMaker alloc] initWithView:self];
...
- (NSArray *)mas_remakeConstraints:(__attribute__((noescape)) void(^)(MASConstraintMaker *make))block {
    self.translatesAutoresizingMaskIntoConstraints = NO;
    MASConstraintMaker *constraintMaker = [[MASConstraintMaker alloc] initWithView:self];
